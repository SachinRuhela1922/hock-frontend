            ...
            <header className={NavCSS.header}>
                ...
                <nav className={`${NavCSS.nav} ${menuOpen ? NavCSS.show : ''}`} id="nav-menu">
                    ...
                    <ul className={NavCSS.navlist}>
                            ...
                            {dropdownOpen && (
                                <ul className={NavCSS.dropdownMenu}>
                                    ...
                                    <li className={NavCSS.dropdownItem}>
                                        <Link to="/team" className={NavCSS.navlink} onClick={closeMenu}>
                                            Training
                                        </Link>
                                    </li>
                                    <li className={NavCSS.dropdownItem}>
                                        <Link to="/careers" className={NavCSS.navlink} onClick={closeMenu}>
                                            Project
                                        </Link>
                                    </li>
                                </ul>
                        ...
                        <li className={NavCSS.navitem}>
                            <Link to="/" className={NavCSS.navlink} onClick={closeMenu}>Blog</Link>
                        </li>
                        <li className={NavCSS.navitem}>
                            <Link to="/" className={NavCSS.navlink} onClick={closeMenu}>Contact</Link>
                        </li>
                        <li className={NavCSS.navitem}>
                            <Link to="/" className={NavCSS.navlink} onClick={closeMenu}>Profile</Link>
                        </li>
                        <li className={NavCSS.navitem}>
